...
app.get("/mostrarCliente/:id/chamados", clientesController.findAllByChamados)
app.get("/mostrarClientes", clientesController.findAll)
app.get("/mostrarAvaliacoes/:id/cliente", clientesController.findAllByAvaliacoes)
app.get("/mostrarComerciosFavoritos/:id/cliente", clientesController.findAllByComerciosFavoritos)
app.get("/mostrarProdutosFavoritos/:id/cliente", clientesController.findAllByProdutosFavoritos)
app.post("/criarCliente", clientesController.create)
app.post("/criarAvaliacao/:idUsuario/comercio/:idComercio", clientesController.createAvaliacao)
app.post("/criarComercioFavorito/:idUsuario/comercio/:idComercio", clientesController.createComercioFavorito)
app.post("/criarProdutoFavorito/:idUsuario/tipoProduto/:idTipoProduto", clientesController.createProdutoFavorito)
...
app.get("/mostrarComerciante/:id/chamados", comerciantesController.findAllByChamados)
app.get("/mostrarComerciante/:id/comercios", comerciantesController.findAllByComercios)
...
app.get("/mostrarAdministrador/:id/chamados", administradoresController.findAllByChamados)
app.get("/mostrarAdministradores", administradoresController.findAll)
app.get("/mostrarResolucoesChamado/:id/administrador", administradoresController.findAllByResolucaoChamados)
app.post("/criarAdministrador", administradoresController.create)
app.post("/criarResolucaoChamado/:idUsuario/resolucaoChamado/:idResolucaoChamado", administradoresController.createResolucaoChamado)
...
app.get("/mostrarComercio/:id/promocoes", comerciosController.findAllByPromocoes)
app.get("/mostrarComercio/:id/produtos", comerciosController.findAllByProdutos)
app.get("/mostrarComercios", comerciosController.findAll)
app.get("/mostrarAvaliacoes/:id/comercio", comerciosController.findAllByAvaliacoes)
app.get("/mostrarComerciosFavoritos/:id/comercio", comerciosController.findAllByComerciosFavoritos)
app.post("/criarComercio", comerciosController.create)
app.put("/editarComercio/:id", comerciosController.update)
app.delete("/apagarComercio/:id", comerciosController.destroy)

app.get("/mostrarProduto/:id", produtosController.findOne)
app.get("/mostrarProduto/:id/promocoes", produtosController.findAllByPromocoes)
...
app.get("/mostrarTipoProduto/:id/produtos", tipoProdutosController.findAllByProdutos)
app.get("/mostrarTipoProdutos", tipoProdutosController.findAll)
app.get("/mostrarProdutosFavoritos/:id/tipoProdutos", tipoProdutosController.findAllByProdutosFavoritos)
...
app.get("/mostrarResolucoesChamado/:id/chamado", chamadosController.findAllByResolucaoChamados)
